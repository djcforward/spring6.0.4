 ...
 *
 * 迭代一组 复合的 {@link PropertySource}
 * 在多个资源共享相同名称的情况下是必要的，例如 当向 {@code @PropertySource} 提供多个值时。
 *
 *
 ...
 * 公开所有积累的资源名称 {@link #getPropertyNames()}（到目前为止 尽可能）。
 *
 * @author Chris Beams
