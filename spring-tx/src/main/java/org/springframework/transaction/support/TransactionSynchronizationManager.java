...
public abstract class TransactionSynchronizationManager {
	 ...
	 * @param key the key to bind the value to (usually the resource factory) 数据库资源
	 * @param value the value to bind (usually the active resource object) 连接
