...
public interface TransactionDefinition {
	 ...
	 *
	 * 如果当前正有一个事务在运行中，则该方法运行在一个嵌套的事务中，被嵌套的事务可以独立于外面的事务进行提交
	 * 或者回滚（保存点）
	 *
	 * 如果没有事务，就跟 PROPAGATION_REQUIRES_NEW 一样
	 */
